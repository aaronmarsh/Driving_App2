package com.example.driving_app
    ...
    private fun getCurrentLocation() {
        ...
        if (ActivityCompat.checkSelfPermission(this,
            ...
            fusedLocClient.lastLocation.addOnCompleteListener {
                ...
                val database: FirebaseDatabase = FirebaseDatabase.getInstance("https://driving-app-3d2f9-default-rtdb.firebaseio.com/")
                val ref: DatabaseReference = database.getReference("Aaron_Samsung")
                if (location != null) {

                    val latLng = LatLng(location.latitude, location.longitude)
                    // create a marker at the exact location
                    map.addMarker(MarkerOptions().position(latLng)
                        .title("Aaron's Samsung"))
